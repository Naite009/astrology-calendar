...
JSON SCHEMA (return exactly this shape, NEW SECTION STRUCTURE):
{
  ...
  "householdInTheMoment": [
    ...
    // generate 2-4 scenarios total for the household
  ],
