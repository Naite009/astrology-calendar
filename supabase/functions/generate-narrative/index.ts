...
8. Pressure/wound paragraph: Only discuss Saturn patterns or hard aspects that ACTUALLY appear in the pressure points list (only if shadow enabled)
9. Closing: 2-3 sentences with a gentle growth lever
...
Write the narrative now as flowing prose paragraphs. Remember: always include house numbers when discussing planets, and only mention aspects that appear in the verified aspects list above.`;
