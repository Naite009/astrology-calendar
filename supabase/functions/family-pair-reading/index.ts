...
JSON SCHEMA:
{
  ...
  "inTheMoment": [
    { "scenario": string (one short, concrete escalation moment THIS child actually has, named in plain parent language, e.g. "When voice gets louder", "When they shut down mid-conversation", "When they refuse a transition", "When they get teary at correction", "When they argue back instead of stopping" — the scenario MUST be calibrated to this specific child's Moon/Mars/Mercury/Saturn pattern, not generic),
    ...
    // generate 2-4 scenarios total, each tied to a different real pressure point in THIS child's chart
  ],
