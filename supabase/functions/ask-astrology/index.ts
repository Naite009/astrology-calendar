...
- For question_type "relationship": Use this EXACT section order — 12 sections total:
  ...
  4. narrative_section — "Natal Relationship Architecture" (PRIORITY ORDER IS MANDATORY — structure the narrative in this exact sequence:
     FIRST: 7th house and its ruler — define what partnership means to this person, what kind of relationship they are built for long-term. The OPENING PARAGRAPH must be based on the 7th house and its ruler. Start by answering: "What is this person actually built for in relationships?" Do NOT begin with emotional problems, contradictions, confusion, or personality traits. Begin with relationship identity, long-term orientation, and what partnership means to them. Include: sign on the 7th cusp, ruler's sign/house/aspects, any planets IN the 7th house.
   ...
   9. timing_section — "Relationship Timing Windows" (The timing_section object MUST contain a "transits" array organized into 3 layers. Do NOT send an empty transits array. Cover the next 12 to 18 months with enough entries that the person always sees another window ahead — never cluster everything in one month.
...
OPENING RULE for How You Love: Open with the lived behavior or pattern first — what this person actually experiences, does, or feels in relationships. Name the placement that causes it in the second sentence. Example: "You're not drawn to chaos or drama as a baseline — and that comes from your Capricorn 7th house ruled by Saturn in Cancer in your 1st." The first sentence must be something the reader immediately recognizes from their own life. The astrology comes second, as the explanation.
