...
- Each of the 6 experience bullets should be 1-3 sentences of real-life description. No abstractions.
  ...
  11. summary_box — "Strategy Summary" with items: "Best Type of Place Overall", "What to Prioritize When Choosing", "What to Avoid Repeating (Pattern)", "Ideal Timing Window", "Analysis Mode". DO NOT add "Top Cities This Year" or "Top Cities Long-Term" items to the summary_box — those cities are already shown in the city_comparison cards above and listing them again in the summary is pure repetition. The summary is for STRATEGIC PRINCIPLES the reader takes away, not a re-listing of cities. The body field still synthesizes the core takeaway in 2-3 sentences.
