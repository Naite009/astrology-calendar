...
- For question_type "relationship": INHERITS UNIVERSAL BASE — BASE RULES 1–9 are non-overridable for this reading type. Use this EXACT section order — 12 sections total:
...
- Each of the 6 experience bullets should be 1-3 sentences of real-life description. No abstractions.
  - For question_type "relocation": INHERITS UNIVERSAL BASE — BASE RULES 1–9 are non-overridable for this reading type. Use this EXACT section order — do NOT rearrange, combine, or skip sections between regenerations:
...
- For question_type "career": INHERITS UNIVERSAL BASE — BASE RULES 1–9 are non-overridable for this reading type. Use this EXACT section order:
  1. placement_table — "Key Placements"
...
- For question_type "health": INHERITS UNIVERSAL BASE — BASE RULES 1–9 are non-overridable for this reading type. Use this EXACT section order:
  1. placement_table — "Key Placements"
...
- For question_type "money": INHERITS UNIVERSAL BASE — BASE RULES 1–9 are non-overridable for this reading type. Use this EXACT section order:
  1. placement_table — "Key Placements"
...
- For question_type "natal": INHERITS UNIVERSAL BASE — BASE RULES 1–9 are non-overridable for this reading type.
...
- For question_type "spiritual": INHERITS UNIVERSAL BASE — BASE RULES 1–9 are non-overridable for this reading type. Use this EXACT section order:
  1. placement_table — "Key Placements"
...
- For question_type "timing": INHERITS UNIVERSAL BASE — BASE RULES 1–9 are non-overridable for this reading type. Lead with timing_section, then narrative_section, then modality_element, then summary_box.
- For question_type "general": INHERITS UNIVERSAL BASE — BASE RULES 1–9 are non-overridable for this reading type. Use narrative_section sections only + modality_element + summary_box.
