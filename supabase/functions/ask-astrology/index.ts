...
- For question_type "relationship": Use this EXACT section order — 10 sections total:
  ...
  5. narrative_section — "Solar Return Love Activation" (SR Venus sign/house, SR Moon sign/house, SR 5th/7th house cusps and planets, SR Juno if available, SR outer planets aspecting 5th/7th/Venus/Mars/Moon/Descendant. EVERY claim must cite the specific SR placement, e.g. "SR Venus in Aries in the 6th suggests..." — only if that SR data exists. If SR data is partial, say so and limit interpretation. Synthesize: year's relationship tone, new vs deepening relationships, instability vs commitment, healing themes, best environments for meeting someone.)
  6. narrative_section — "Natal & Solar Return Overlay" (EXPLICIT cross-chart logic. For each overlay claim, name the SR factor, the natal factor, and the meaning. Required checks: SR Venus aspecting natal Venus/Moon/Mars/Juno/7th house ruler; SR ASC or DSC within 3° of natal Venus/Moon/Mars/Juno/DSC ruler/Saturn-if-7th-ruler; SR 5th ruler aspecting natal relationship indicators; SR 7th ruler aspecting natal relationship indicators; SR planets falling in natal 5th/7th/8th/11th house; SR angles activating natal Venus/Mars/Moon/7th ruler. Format each as: "SR [factor] [aspect] natal [factor] ([orb]°): [meaning]." Synthesize what is triggered this year vs natal baseline.)
  7. narrative_section — "Relationship Contradiction Patterns" (MANDATORY. Identify internal tensions: What part of the chart wants safety vs what part wants excitement or freedom. What delays or fears commitment. What idealizes love or intimacy. What pattern may repeat unless consciously worked with. Use careful language — differentiate attraction from compatibility, chemistry from durability, relationship opportunity from relationship readiness. Use "lighter in fixed energy" not "lacking fixed energy" when fixed placements exist.)
  8. timing_section — "Relationship Timing Windows" (Minimum 6 transits from Jupiter, Saturn, Uranus, Neptune, Pluto to natal Venus, Mars, Moon, Juno, Descendant, 7th house ruler. EACH transit must include ALL of: transiting_planet, aspect type, natal target, transit degree, date_range (narrowest possible), and tag. Accepted tags: meeting / attraction / commitment / test / rupture / healing. Must include at least 1 supportive and 1 challenging transit. For outer planets with retrograde passes, report each pass separately per the MULTI-PASS rules. If exact dates are available show them; if approximate, label as approximate. Do NOT collapse multiple passes into one range.)
  9. modality_element — "Elemental & Modal Balance"
  10. summary_box — "Relationship Strategy Summary" with items: "Who to Look For", "Where Love Begins", "Best Windows", "Caution Windows", "What to Avoid Repeating"
