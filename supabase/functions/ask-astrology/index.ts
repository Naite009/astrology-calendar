...
- EVERY narrative_section that has a defined "Profile", "Pattern", "Foundation", "Edge", or "Style" title (e.g., "Relationship Needs Profile", "Your Career Foundation", "Your Earning Style", "Your Vitality Foundation", "Your Soul's Foundation", "Environment Fit Profile") MUST open its "body" field with 2 to 4 sentences of substantive prose (50–110 words) BEFORE any bullets or sub-structure. Sentence 1 = lived behavior the reader recognizes. Sentence 2 = the specific placement causing it. Sentences 3–4 = preview the tension/strength. FORBIDDEN: empty body, single-sentence stub, meta sentence like "These are the core forces that shape how you work" — every sentence must make a substantive claim about THIS chart.
- HARD FAIL: If you ship a summary_box with empty body, a modality_element with empty balance_interpretation, or any of the listed narrative_sections with an empty/stub body, the reading FAILS the final check and is incomplete regardless of how good the rest of the content is. Re-check every section's body field before returning.
