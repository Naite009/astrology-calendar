...
- For question_type "relationship": Use this EXACT section order — 11 sections total:
  ...
  3. narrative_section — "Natal Relationship Architecture" (PRIORITY ORDER IS MANDATORY — structure the narrative in this exact sequence:
     FIRST: 7th house and its ruler — define what partnership means to this person, what kind of relationship they are built for long-term. The OPENING PARAGRAPH must be based on the 7th house and its ruler. Start by answering: "What is this person actually built for in relationships?" Do NOT begin with emotional problems, contradictions, confusion, or personality traits. Begin with relationship identity, long-term orientation, and what partnership means to them.
     SECOND: Venus — how they express love, what feels good and natural in connection.
     THIRD: Moon — what they need emotionally to feel safe, what allows them to stay and open up.
     FOURTH: Mars — what initially attracts them, what creates chemistry or interest early on.
     FIFTH: Additional factors (5th house, 8th house, Nodes, Juno, Lilith if data present) — only include if they add NEW insight not already covered. Use these to explain patterns, repetition, or growth edges.
     ...
     COMPRESSION RULE: Do not repeat the same idea in multiple ways. If a concept has been explained clearly, do not restate it unless adding something new.)
