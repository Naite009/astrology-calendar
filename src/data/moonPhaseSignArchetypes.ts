...
export const MOON_PHASE_SIGN_ARCHETYPES: Record<string, Record<string, MoonArchetype>> = {
  ...
  'Waxing Crescent': {
    ...
    Leo: {
      ...
      healingPath: "Through tears. Not comedy improv but honest grief work. Healing comes when you discover that your audience still loves you even when you're not funny.",
  ...
  'First Quarter': {
    ...
    Gemini: {
      ...
      description: "The Liar's Moon is not actually about lying — it's about the CRISIS of truth. You are confronted with the enormous power of language: words can heal or destroy, illuminate or deceive, connect or manipulate. You've experienced both sides of this power, and the crisis is deciding how you'll use it. This Moon marks the soul wrestling with honesty — the moment when clever word-play must give way to genuine communication. When you choose truth, your words become medicine. When you choose deception (even self-deception), they become poison.",
    ...
    Cancer: {
      ...
      gifts: ["Profound emotional depth", "Compassion born from suffering", "Ability to hold space for others' grief", "Emotional honesty"],
    ...
    Leo: {
      ...
      challenges: ["Identity confusion", "Difficulty knowing your honest self", "Can perform love instead of feeling it", "Fear of being seen without the mask"],
      soulLesson: "Learning that the greatest role you'll ever play is yourself — that honesty is the ultimate performance art.",
      ...
      healingPath: "Through private honest expression — journaling, solo creative practice, therapy focused on identity. Healing comes when you discover that the person behind the mask is more interesting than any character.",
      ...
      sacredPurpose: "To show the collective that honesty IS the ultimate art — that being yourself is the hardest, bravest, most creative act.",
    ...
    Sagittarius: {
      ...
      gifts: ["Willingness to question everything", "Ability to rebuild belief from the ground up", "Philosophical courage", "Deep honesty"],
    ...
    Aquarius: {
      ...
      inRelationships: "You bring honesty, passion, and refusal to settle for a conventional relationship. Your challenge is not rebelling against your partner.",
  ...
  'Waxing Gibbous': {
    ...
    Leo: {
      ...
      challenges: ["Perfectionism about the craft", "Can lose spontaneity in refinement", "May compare self to other 'singers'", "Fear that refining means losing honesty"],
      ...
      sacredPurpose: "To remind the collective that honest self-expression is not vanity but NECESSITY — that each person's unique voice is needed in the chorus.",
    ...
    Scorpio: {
      ...
      coreWound: "The wound of misused power — you may have experienced power being used against you, or used your ability to trust yourself destructively. Now you must learn to trust yourself with the intensity you carry.",
  ...
  'Full Moon': {
    Aries: {
      ...
      gifts: ["Tested courage", "Complete honesty", "Ability to lead in crisis", "Inspiring others through visible bravery"],
    ...
    Leo: {
      name: "Queen's Moon",
      essence: "Royal power fulfilled — the sovereign who has earned her throne through honest self-expression.",
      description: "The Queen's Moon is Leo at its crowning moment — the soul that has earned its authority through genuine, tested self-expression. This isn't inherited power; it's power EARNED through the courage to be completely, vulnerably, honestly yourself in front of the world.",
      gifts: ["Natural authority earned through honesty", "Magnetic presence", "Inspiring leadership", "Grace under the spotlight"],
      ...
      sacredPurpose: "To model honest power — proving that the most magnetic authority comes from being fully, vulnerably yourself.",
      ...
      affirmation: "My power is honest. I rule by being myself, not by performing royalty."
    },
    Virgo: {
      name: "Spinner's Moon",
  ...
  'Last Quarter': {
    ...
    Gemini: {
      ...
      healingPath: "Through radical honesty — performing no tricks, using no illusions. Healing comes when reality without embellishment turns out to be more magical than any spell.",
    ...
    Scorpio: {
      ...
      inRelationships: "You bring honest rawness and willingness to be completely unmasked. Your challenge is giving your partner time to adjust.",
