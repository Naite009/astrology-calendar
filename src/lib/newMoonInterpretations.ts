...
const CONJUNCTION_FELT_SENSE: Record<string, string> = {
  ...
  Uranus: '♅Uranus joins this New Moon — expect the unexpected. You may feel electrically charged, restless, or suddenly clear about something you need to change. There\'s a rebellious quality — old patterns feel suffocating. Intentions around freedom, honesty, or radical change have extra voltage. Don\'t be surprised if your plans shift suddenly.',
  ...
  Pluto: '♇Pluto joins this New Moon — this operates at the soul level. You may feel an undercurrent of intensity, a pull toward truth that won\'t let you settle for surface-level intentions. Old power dynamics may surface. Set intentions from your deepest honest self, not from ego or fear. What begins now involves permanent transformation.',
