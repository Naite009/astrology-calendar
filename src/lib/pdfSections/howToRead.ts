...
export function generateHowToReadPage(ctx: PDFContext, doc: jsPDF) {
  ...
  const concepts: { title: string; body: string }[] = [
    ...
    },
    {
      ...
      body: 'Aspects are geometric angles between planets. A conjunction (0 degrees) blends energies. A trine (120 degrees) creates flow. A square (90 degrees) creates tension that forces action. An opposition (180 degrees) creates awareness through contrast.',
    },
    {
