    ...
    return {
      ...
      detail: {
        ...
        bodyParagraphs: [
          ...
          'Here is what each upper house governs: the 7th house is committed partnerships — marriage, business partners, one-on-one relationships where you must negotiate and compromise. The 8th house is shared finances, intimacy, and deep psychological transformation — joint accounts, inheritance, therapy, sexuality. The 9th house is travel, higher education, philosophy, and publishing — your worldview expanding beyond the familiar. The 10th house is career, reputation, and authority figures — your professional standing and how the world judges your contribution. The 11th house is friendships, communities, social causes, and long-term goals — the groups you belong to and your vision for the future. The 12th house is solitude, spiritual practice, the unconscious, and endings — not public at all, but about surrendering personal control to something larger.',
          intensity === 'extreme'
            ? 'With such a dramatic upper concentration, this year\'s lessons arrive THROUGH other people, institutions, and circumstances rather than through solo initiative. Whether through a partner (7th), a financial entanglement or loss (8th), a journey or course of study (9th), a career demand (10th), a community obligation (11th), or enforced solitude and inner processing (12th), the common thread is that external forces and other people set the agenda.'
            : 'This moderate upper lean suggests a year where relational engagement and external systems take priority without completely eclipsing your personal agency. You\'ll spend more time navigating partnerships (7th), shared resources (8th), career dynamics (10th), or collective responsibilities (11th).',
          'Upper-hemisphere Solar Returns often coincide with marriage or divorce (7th), financial mergers or debt restructuring (8th), travel or enrolling in a program (9th), job changes or promotions (10th), joining organizations or activism (11th), or periods of retreat, hospitalization, or spiritual awakening (12th).'
        ],
        focusAreas: [
  ...
  return {
    ...
    detail: {
      ...
      bodyParagraphs: [
        ...
        'Here is what each lower house governs: the 1st house is your physical appearance, first impressions, and personal identity — how you show up in a room. The 2nd house is your money, possessions, and self-worth — what you earn, spend, and value. The 3rd house is siblings, neighbors, short trips, and everyday communication — emails, conversations, errands, local travel. The 4th house is home, family, parents, and your private emotional foundation — where you live and where you come from. The 5th house is romance, creativity, children, fun, and self-expression — dating, hobbies, artistic projects, gambling. The 6th house is daily work, health, routines, and pets — your job duties, exercise habits, and physical wellness.',
        intensity === 'extreme'
          ? 'With such a strong lower concentration, this is emphatically a year where you build from the ground up on your own terms. Whether it\'s a body transformation (1st), getting finances in order (2nd), learning a new skill (3rd), moving or redecorating (4th), starting a creative project or new romance (5th), or overhauling your health routine (6th) — the common thread is that YOU are driving the change, on YOUR schedule.'
        ...
        'Lower-hemisphere years often coincide with image makeovers or new looks (1st), salary negotiations or budgeting overhauls (2nd), starting a blog or taking a course (3rd), moving or renovating (4th), falling in love or having a baby (5th), or starting a new fitness or work routine (6th).'
      ],
      focusAreas: [
