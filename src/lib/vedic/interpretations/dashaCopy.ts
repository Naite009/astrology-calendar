...
export const DASHA_COPY: Record<VedicPlanet, DashaCopy> = {
  Sun: {
    title: 'visibility is emphasized',
  ...
  Moon: {
    title: 'home and emotional life are emphasized',
  ...
  Mercury: {
    title: 'learning and decisions are emphasized',
  ...
  Venus: {
    title: 'love, values and enjoyment are emphasized',
    asks: 'that you become clearer about what and whom you value, and let life be enjoyable rather than only earned',
    gives: 'more attention to relationships, beauty, comfort and the way you receive and share affection',
    trap: 'keeping the peace at a cost you are not admitting to',
  },
  Saturn: {
    title: 'structure is emphasized',
  ...
  Rahu: {
    title: 'the unfamiliar is emphasized',
