...
export const generateCharacterSynthesis = (
  ...
  if (tripleSign) {
    const tripleSignDescriptions: Record<string, string> = {
      Aries: `You are pure fire, undiluted warrior energy. With Sun, Moon, and Rising all in Aries, there is no mask—who you are, what you feel, and how you appear are one seamless identity. You are direct, courageous, and pioneering. You cannot pretend. Your gift is honest action and the courage to go first. Your challenge is patience, collaboration, and recognizing when to follow.`,
...
Your challenges: Decision paralysis from seeing all sides equally. Losing yourself in the mirror of relationship. Conflict avoidance that postpones necessary truth-telling. Learning that sometimes rupture serves love better than false peace. The journey from people-pleasing to honest relating.
...
The Libra esoteric meaning: The end of duality. Male and female in tandem. Personality and soul balanced. You are learning that the ultimate relationship is the one between your human self and your divine self—the sacred marriage within.`,
      ...
      Aquarius: `You are pure Uranus—innovation, individuality, and humanitarian vision. With Sun, Moon, and Rising all in Aquarius, your entire being is oriented toward the future, the collective, and being honestly different. You cannot pretend to be normal even when you try. Your gift is original thinking and the ability to see what others will only understand later. Your challenge is intimacy, emotional accessibility, and staying connected to the present while envisioning the future.`,
