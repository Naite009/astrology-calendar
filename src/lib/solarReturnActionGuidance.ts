...
const PLANET_HOUSE_GUIDANCE: Record<string, Record<number, HouseGuidance>> = {
  ...
  Saturn: {
    ...
    7: { leanInto: 'Relationship commitment, clear partnership agreements, honest assessments', avoid: 'Staying in dead relationships from duty, emotional withholding', bestUse: 'Decide: commit fully or release honestly — this area of your life doesn\'t do halfway this year' },
    ...
    9: { leanInto: 'Formal education, structured travel, deepening philosophical commitments', avoid: 'Rigid beliefs, fear of the unknown, canceling trips from anxiety', bestUse: 'Enroll in the program or plan the trip that requires commitment — follow-through is rewarded this year' },
    10: { leanInto: 'Career building, accepting authority, professional mastery', avoid: 'Overwork, neglecting personal life for ambition, fear of visibility', bestUse: 'Take on the responsibility — the promotion, the project, the leadership role. You\'re ready even if you don\'t feel it' },
    11: { leanInto: 'Quality friendships, meaningful group commitments, long-term social goals', avoid: 'Social isolation, fair-weather friendships, giving up on community', bestUse: 'Invest in 2-3 friendships that matter — depth over breadth is the rule this year' },
