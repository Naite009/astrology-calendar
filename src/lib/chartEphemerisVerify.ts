...
const TOLERANCES: Record<string, Tolerance> = {
  ...
  Chiron: { verified: 6, close: 30, note: 'JPL Horizons data, 1920-01-01 to 2059-12-27, interpolated between 10-day samples (within about 1 arc-minute).' },
  Ceres: { verified: 6, close: 30, note: 'JPL Horizons data, 1920-01-01 to 2059-12-27, interpolated between 10-day samples (within about 1 arc-minute).' },
  Pallas: { verified: 6, close: 30, note: 'JPL Horizons data, 1920-01-01 to 2059-12-27, interpolated between 10-day samples (within about 1 arc-minute).' },
  Juno: { verified: 6, close: 30, note: 'JPL Horizons data, 1920-01-01 to 2059-12-27, interpolated between 10-day samples (within about 1 arc-minute).' },
