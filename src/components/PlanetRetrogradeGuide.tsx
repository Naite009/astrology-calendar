...
const PLANET_INFO: Record<string, {
  ...
  Venus: {
    ...
    dignityTeaching: {
      intro: "Venus has TWO home signs — Taurus and Libra — because love and beauty express in two fundamentally different ways: through the senses and the body (Taurus) and through relationship and harmony (Libra). This means she has TWO detriment signs — Scorpio and Aries — where her gentle, pleasure-seeking energy meets the most friction. Understanding Venus's dignities isn't just astrology trivia — it's a map of how every human being experiences love, beauty, and self-worth.",
      analogy: "Think of Venus like a master chef. In Taurus, she's in her own kitchen — organic ingredients, no rush, every dish is a sensory masterpiece. The table is set with fresh flowers. She cooks by touch, taste, and instinct. In Libra, she's hosting an elegant dinner party — the food matters, but what REALLY matters is that everyone feels welcome, the conversation sparkles, and no one leaves feeling excluded. In Scorpio (detriment), someone's locked her in a dungeon kitchen and said 'Cook with whatever you find in the dark.' She can do it — and the food is raw, primal, unforgettable — but it costs her everything. In Aries (detriment), someone's thrown her ingredients out of a moving car and said 'Make it fast!' She burns things, cuts herself, and the food is weirdly exciting but nobody would call it 'beautiful.' In Pisces (exaltation), she's cooking for God — the meal is transcendent, otherworldly, and everyone weeps because they've never tasted anything so holy. In Virgo (fall), she's been given a recipe book with 400 rules and told 'Follow every step exactly.' The food is technically perfect — and completely soulless.",
      domicile: [
        {
          sign: "Taurus",
          title: "Venus in Taurus — The Sensual Home",
          feltSense: "This feels like sinking into a warm bath while your favorite song plays. Every sense is alive — the texture of fabric against skin, the taste of ripe fruit, the smell of rain on earth. There's no rush. Time stretches like honey. You don't THINK about pleasure; you ARE pleasure. The body knows exactly what it wants and feels zero guilt about wanting it. Comfort isn't laziness here — it's a spiritual practice.",
          psychology: "Venus in Taurus is Venus operating through the body and the physical senses. Love is demonstrated through acts of physical care: cooking for someone, giving massages, creating a beautiful living space. Self-worth is grounded in what feels tangible and real — not in ideas about worth, but in the felt sense of 'I am enough because I can feel myself existing and it feels good.' When retrograde: 'Have I confused comfort with avoidance? Am I using physical pleasure to numb emotional pain? What do I TRULY value beneath all the things I've accumulated?'",
          gifts: ["Extraordinary sensory awareness — natural talent for food, art, music, design", "Unshakeable loyalty and steadfastness in love", "Ability to create environments that heal through beauty", "Grounded self-worth that doesn't depend on others' opinions", "Patience in love — willing to build slowly and sustainably"],
          challenges: ["Possessiveness — 'What I love, I own'", "Resistance to change even when change is desperately needed", "Using comfort as avoidance — staying in bad situations because they're familiar", "Materialism — measuring love by gifts and financial security", "Sensory overindulgence as a coping mechanism"],
          bodyFeeling: "Warmth and heaviness in the throat and neck (Taurus's body parts). A grounded, rooted sensation — feet firmly on the earth. Tension appears as throat tightness or neck stiffness, especially when values feel threatened. When Venus is happy in Taurus, the whole body feels like a purring cat — warm, relaxed, vibrating with contentment."
        },
        {
          sign: "Libra",
          title: "Venus in Libra — The Relational Home",
          feltSense: "This feels like the moment a room full of strangers starts laughing together. There's an invisible thread connecting everyone, and you're the one who wove it. Beauty here isn't about objects — it's about HARMONY between things. A well-matched couple, a perfectly balanced room, a conversation where both people feel truly heard. You feel most alive in relationship — not because you're incomplete alone, but because connection is your art form.",
          psychology: "Venus in Libra is Venus operating through relationship and aesthetic harmony. Love is about partnership, equality, and mutual respect. Self-worth is calibrated through how others respond — not in a codependent way (though that's the shadow), but because Libra genuinely believes that beauty is co-created. When retrograde: 'Have I lost myself in the pursuit of harmony? Am I saying what I actually think, or what will keep the peace? Is my relationship truly balanced, or have I been performing balance while secretly keeping score?'",
          gifts: ["Extraordinary social intelligence — reading a room like poetry", "Creating beauty through arrangement, design, and curation", "Natural mediator — finding the position where all parties feel honored", "Genuine commitment to fairness and equality in relationships", "Making others feel seen, valued, and beautiful in your presence"],
          challenges: ["Chronic people-pleasing — abandoning your own needs to maintain harmony", "Indecisiveness — seeing all sides so clearly that choosing feels violent", "Passive aggression — anger expressed through withdrawal or icy politeness", "Defining self-worth through relationship status", "Avoiding conflict until it explodes — the 'everything is fine' smile hiding a volcano"],
          bodyFeeling: "Lower back and kidney area (Libra's body parts). A sensitivity to environmental aesthetics — physically uncomfortable in ugly or chaotic spaces. When harmony is present, the body feels light, graceful, almost weightless. When in conflict, lower back pain and a sense of being physically 'off-balance' — as if gravity itself is wrong."
        },
      ],
      exaltation: [
        {
          ...
          feltSense: "This feels like falling in love with the entire universe at once. The boundaries between 'I love you' and 'I AM love' dissolve completely. Music makes you weep. Sunsets are physically painful in their beauty. You feel other people's loneliness as if it were your own. Love here isn't a transaction or even a relationship — it's a state of being. The heart opens so wide that everything floods in: ecstasy AND agony, all swirled together in a watercolor wash of feeling.",
          psychology: "Venus is exalted in Pisces because love reaches its highest expression when it becomes unconditional, selfless, and spiritually transcendent. This is the love of the mystic, the poet, the healer who feels the wound of the world and responds with beauty. When retrograde: 'Am I loving from wholeness or from wounding? Is my compassion genuine, or am I playing the martyr? Have I been loving an idealized fantasy instead of a real human being?'",
          gifts: ["Capacity for unconditional love that transforms everyone it touches", "Artistic and creative genius — channeling the divine through beauty", "Empathic healing — feeling what others need before they say it", "Romantic love that serves as a gateway to the sacred", "Seeing the divine beauty in every imperfect person and thing"],
          challenges: ["Idealization — falling in love with potential rather than reality", "Martyrdom — sacrificing self-worth for others' comfort", "Boundary dissolution — losing yourself in relationships completely", "Enabling destructive people because you 'see their light'", "Confusing pity with love, or suffering with depth"],
          bodyFeeling: "Feet and lymphatic system (Pisces body parts). A floating, dreamy quality — as if you're not fully embodied. Tears flow easily and without warning. The body feels porous, absorbing the emotional atmosphere of any room. When love is present, a warm oceanic sensation floods the chest like light through water."
        },
      ],
      detriment: [
        {
          sign: "Scorpio",
          title: "Venus in Scorpio — Love in the Underworld",
          feltSense: "This feels like falling in love while falling off a cliff. There's no casual here — every connection is life-or-death intensity. You don't 'like' people; you're consumed by them or indifferent to them. There's no middle. When you want someone, the desire is a physical ache — deep in the belly, almost indistinguishable from hunger or grief. Trust is the rarest commodity. You test people, consciously or not, to see if they'll stay when they see the real you.",
          psychology: "Venus in Scorpio is detriment because Scorpio is opposite Taurus — Venus's most comfortable, sensory home. Instead of 'love is simple, love is pleasure,' Scorpio says 'love is transformation, love is death and rebirth.' The goddess of beauty is dragged into the underworld and forced to love in the dark. This isn't comfortable — but it's the most REAL love in the zodiac. Nothing is surface. Every relationship becomes therapy. When retrograde: 'Who am I controlling in the name of love? Where has my intensity become a cage? What am I afraid will happen if I love without possessing?'",
          gifts: ["Emotional depth that creates bonds of extraordinary intensity", "Psychological insight — seeing through every mask and pretense", "Fierce loyalty — once committed, committed to death", "Sexual and emotional honesty that transforms both partners", "Capacity to love the shadow — the parts others reject"],
          challenges: ["Jealousy and possessiveness that suffocate partners", "Using emotional intimacy as a weapon or leverage", "Testing people to destruction — 'proving' they'll betray you", "All-or-nothing relationships — no room for nuance", "Vengefulness when betrayed — nuclear-level relationship endings"],
          bodyFeeling: "Intense sensation in the reproductive organs and lower belly (Scorpio's body parts). A coiled, magnetic energy that draws people in. Jealousy registers as a physical burning in the solar plexus. Desire and grief feel almost identical. When trust is broken, the body goes cold — a visceral shutdown that can take months to thaw."
        },
        {
          sign: "Aries",
          title: "Venus in Aries — Love at Full Speed",
          feltSense: "This feels like wanting to be swept off your feet and doing the sweeping yourself because nobody moves fast enough. Love is exciting, urgent, competitive. You fall hard and fast — and sometimes fall out just as quickly when the thrill fades. There's a restlessness in love: 'Is this it? Is this enough? What's NEXT?' Patience in romance feels like death. You'd rather fight than endure boredom.",
          psychology: "Venus in Aries is detriment because Aries is opposite Libra — Venus's relational home. Instead of 'let's find harmony together,' Aries says 'I want what I want and I want it NOW.' The goddess of love has to love through competition, independence, and self-assertion. This isn't unloving — it's Venus learning that love doesn't require self-abandonment. When retrograde: 'Do I chase love because I want connection, or because I want to win? Can I stay when the excitement fades? What would love look like if I stopped performing strength?'",
          gifts: ["Courageous in love — willing to make the first move, always", "Refreshing honesty — you always know where you stand", "Passion that revitalizes stale relationships", "Independence that prevents codependency", "Fighting for love rather than passively accepting less"],
          challenges: ["Impulsiveness — falling in love with the idea of someone", "Competitiveness in relationships — needing to 'win' at love", "Difficulty with vulnerability — mistaking softness for weakness", "Short attention span in romance — boredom kills attraction", "Anger flares in love — fighting as foreplay, but also as destruction"],
          bodyFeeling: "Heat in the head and face (Aries body parts). A rushing sensation — blood moving fast, heart pounding. Desire feels like adrenaline. When frustrated in love, headaches and jaw clenching. The body wants to MOVE toward what it desires — sitting still while in love feels physically impossible."
        },
      ],
      fall: [
        {
          sign: "Virgo",
          title: "Venus in Virgo — Love Under the Microscope",
          feltSense: "This feels like wanting desperately to love freely but being unable to turn off the analytical mind. You notice EVERYTHING — the way they chew, the grammar in their texts, the slightly uneven picture. It's not that you don't feel love; it's that love passes through a filter of evaluation before it reaches your heart. You show love through acts of service: fixing, organizing, improving. The tragedy is that what you crave — unconditional love — is exactly what you struggle to offer.",
          psychology: "Venus in Virgo is in fall because Virgo is opposite Pisces — where Venus is exalted in unconditional love. Instead of 'I love everything without judgment,' Virgo says 'I love you, but have you considered improving?' Love becomes a project. The gift is that Venus in Virgo offers love that actually HELPS — not just love that feels good, but love that makes you better. The danger is conditional love. When retrograde: 'Am I loving people or improving them? Can I accept imperfection in myself before demanding it of others?'",
          gifts: ["Love expressed through practical devotion — real help, not just words", "Discernment in relationships — not fooled by charm without substance", "Creating order and beauty from chaos — domestic genius", "Attention to what partners actually NEED (not just want)", "Humility in love — not needing to be the star, just useful"],
          challenges: ["Chronic criticism — picking apart loved ones 'for their own good'", "Self-criticism that blocks receiving love — 'I'm not worthy enough yet'", "Analysis paralysis in romance — overthinking kills spontaneity", "Worrying about relationships instead of enjoying them", "Impossible standards that no human can meet — including yourself"],
          bodyFeeling: "Digestive tension and gut anxiety (Virgo's body parts). A nervous, fluttery stomach when falling in love — not butterflies so much as anxious rumbling. The hands want to be busy — cooking, cleaning, organizing — especially when emotions feel overwhelming. When love feels unsafe, the body converts emotional pain into physical symptoms: stomach aches, skin irritation, sleep disruption."
        },
      ],
    },
  ...
  Mars: {
    ...
    signMeanings: {
      ...
      Leo: "Mars retrograde in Leo: Creative drive stalls. Ego battles revisited. Reclaiming honest self-expression.",
  ...
  Jupiter: {
    ...
    signMeanings: {
      Aries: "Jupiter retrograde in Aries: Reconsidering bold initiatives. Is your confidence honest or performative?",
  ...
  Uranus: {
    ...
    dignityTeaching: {
      ...
      detriment: [{
        ...
        feltSense: "This feels like wanting to be utterly unique while also desperately wanting applause. There's a tension between honest individuality and performative rebellion. Creativity is electric but can become erratic. The ego and the collective future are in constant negotiation.",
        ...
        gifts: ["Wildly original creative expression", "Courage to be radically honest in public", "Inspiring others through personal revolution", "Creative genius that breaks artistic conventions", "Magnetic individuality"],
  ...
  Neptune: {
    ...
    signMeanings: {
      ...
      Leo: "Neptune retrograde in Leo: Creative inspiration turns mystical. Performance vs. honesty examined.",
      ...
      Sagittarius: "Neptune retrograde in Sagittarius: Spiritual beliefs tested for honesty. Guru projections withdrawn.",
  ...
  Pluto: {
    ...
    dignityTeaching: {
      ...
      exaltation: [{
        ...
        gifts: ["Transformative creative vision", "Charismatic leadership", "Courage to express power honestly", "Using personal magnetism for collective transformation", "Generational creative legacy"],
