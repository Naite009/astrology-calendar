  ...
  const mercurySect = useMemo(() => {
    ...
    return {
      ...
      description: isMorningStar 
        ? 'At the moment you were born, Mercury was ahead of the Sun in the sky — meaning if you looked at the horizon before sunrise, Mercury was already up. That\'s what makes YOUR Mercury a "Morning Star." (Everyone\'s Mercury is either a Morning or Evening Star depending on where it was when they were born — it\'s not about being born in the morning.) Because Morning Star Mercury is up before the Sun, ancient astrologers put it on the Day team. What this means for you: your thinking style is direct and active. You tend to process ideas out loud, reach conclusions quickly, and your sharpest insights come when you\'re fully engaged and alert.'
        : 'At the moment you were born, Mercury was behind the Sun in the sky — meaning if you looked at the horizon after sunset, Mercury was still visible. That\'s what makes YOUR Mercury an "Evening Star." (Everyone\'s Mercury is either a Morning or Evening Star depending on where it was when they were born — it\'s not about being born at night.) Because Evening Star Mercury lingers after the Sun sets, ancient astrologers put it on the Night team. What this means for you: your thinking style is reflective and receptive. Ideas tend to come to you in quiet moments, your gut feelings carry real intelligence, and you often "just know" things before you can explain why.'
    };
