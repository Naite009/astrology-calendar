  ...
  const mercurySect = useMemo(() => {
    ...
    return {
      ...
      description: isMorningStar 
        ? 'Mercury is the only planet that can switch teams — every other planet is locked to Day or Night permanently. Mercury switches based on which side of the Sun it sits on in your birth chart. In your chart, Mercury is on the "ahead of the Sun" side, so it plays for the Day team. This gives your mind a direct, active quality — you think by doing, talking it out, and engaging with the world head-on.'
        : 'Mercury is the only planet that can switch teams — every other planet is locked to Day or Night permanently. Mercury switches based on which side of the Sun it sits on in your birth chart. In your chart, Mercury is on the "behind the Sun" side, so it plays for the Night team. This gives your mind a reflective, receptive quality — you think by processing internally, and your best ideas arrive in quiet moments or as gut feelings you can trust.'
    };
