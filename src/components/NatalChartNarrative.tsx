...
const SIGN_EXPRESSIONS: Record<string, Record<string, string>> = {
  ...
  uranus: {
    ...
    leo: "Revolutionary self-expression. Your generation transforms creativity and individuality. You awaken through honest self-presentation and new art forms.",
  ...
  pluto: {
    ...
    taurus: "Power through resources. Your generation transforms material values and relationship to Earth. You regenerate by reclaiming honest self-worth.",
    gemini: "Power through communication. Your generation transforms information and mental paradigms. You regenerate by reclaiming your honest voice.",
    ...
    sagittarius: "Power through belief. Your generation transforms religion, education, and global connection. You regenerate by reclaiming honest truth.",
  ...
  northnode: {
    aries: "Growth through independence. You're learning to assert yourself, take initiative, and develop courage. Your long-standing comfort zone is in pleasing others.",
    taurus: "Growth through stability. You're learning to build value, trust the body, and develop patience. Your long-standing comfort zone is in intensity and crisis.",
    gemini: "Growth through communication. You're learning to listen, share ideas, and stay curious. Your long-standing comfort zone is in big-picture thinking.",
    cancer: "Growth through nurturing. You're learning to feel deeply, create home, and care for others. Your long-standing comfort zone is in achievement and control.",
    leo: "Growth through creativity. You're learning to shine, express yourself, and follow your heart. Your long-standing comfort zone is in group identity.",
    virgo: "Growth through service. You're learning to be useful, discern clearly, and perfect your craft. Your long-standing comfort zone is in escaping into fantasy.",
    libra: "Growth through partnership. You're learning to cooperate, find balance, and create harmony. Your long-standing comfort zone is in self-focus.",
    scorpio: "Growth through real change in how you act. You're learning to merge deeply, release control, and let intensity be okay. Your long-standing comfort zone is in chasing material security.",
    sagittarius: "Growth through expansion. You're learning to seek truth, travel widely, and think big. Your long-standing comfort zone is in local concerns.",
    capricorn: "Growth through mastery. You're learning to achieve, build structure, and take responsibility. Your long-standing comfort zone is in emotional dependency.",
    aquarius: "Growth through innovation. You're learning to think collectively, embrace uniqueness, and serve humanity. Your long-standing comfort zone is in personal drama.",
    pisces: "Growth through letting go. You're learning to surrender, trust life, and stop forcing outcomes. Your long-standing comfort zone is in over-analysis and control.",
  },
  lilith: {
...
const NATAL_ASPECT_INTERPRETATIONS: Record<string, Record<string, string>> = {
  ...
  'Sun-Uranus': {
    conjunction: "Unique, rebellious identity. You must be honest above all. Sudden changes define your path.",
