    ...
    events: [
      {
        ...
        description: 'The opening lunar eclipse of the Virgo-Pisces series. A lunar eclipse is always a Full Moon — a moment of completion, revelation, and release. The Moon in Pisces is your instinct, your past, your attachments, your emotional body. The Sun in Virgo is your conscious awareness — but the Earth stands between them, casting its shadow. The life you are living NOW (Earth) is blocking the light of awareness (Sun) from reaching your unconscious patterns (Moon). What was hidden becomes visible. This is not a time for manifestation — that belongs to solar eclipses. This is a time for revelation: seeing what has run its course, what is outdated, what your nervous system has been holding onto as a survival strategy that you no longer need. The Virgo-Pisces axis activates everything about your health (emotional AND physical body), your daily routines and rituals, what you give through work and service, and the relationship between practical reality and spiritual meaning. The question this eclipse asks: "Show me what is hidden. Show me what has run its course. What can I release so something new can enter?"',
        nodalTheme: 'South Node in Pisces: This is a karmic eclipse. The South Node of the Moon represents past patterns — the unconscious contracts you made long ago to get love, to feel safe, to stay connected. These were nervous system strategies that once protected you, but they have become burdens your younger parts are still carrying. The Moon (past, instinct, attachment) is conjunct the South Node — the pattern from long ago is RIGHT HERE, visible in your body. Meanwhile, the Sun sits with the North Node in Virgo — that is where your soul wants to go. You, on Earth, are in the middle. Your job is to interrupt the pattern. To work with your shadow — not push it away, but hold it, see it, and consciously choose to release what no longer serves. Pisces South Node patterns include: dissolving your own needs, chronic self-sacrifice, emotional chaos mistaken for depth, and using spirituality to avoid the practical work of living.',
        releasingThemes: [
          ...
          'Martyrdom — giving beyond capacity and quietly resenting it, then calling it spiritual',
          'Escapism and confusion maintained because clarity feels too confronting',
          'The burdens your younger parts are still holding — exiles that need acknowledgment, not suppression',
        ],
        buildingThemes: [
          'Conscious awareness of your shadow patterns — seeing them without judgment',
          ...
          'A more grounded relationship between your spiritual life and your daily practical reality',
          'The groundwork for daily routines that actually nourish rather than deplete',
        ],
        reflectionQuestions: [
          'What unconscious contract am I still honoring — what did I agree to long ago in order to feel loved or safe?',
          'Where is this pattern showing up in my body right now? What is my body trying to tell me?',
          'What nervous system strategy (people-pleasing, perfectionism, withdrawal, over-giving) has run its course?',
          'Where have I been the martyr — giving beyond my capacity and calling it virtue?',
        ...
        aspects: [
          { planet: 'Neptune', type: 'conjunction', sign: 'Pisces', meaning: 'Neptune at ~28° Pisces is conjunct this eclipse within 3° — the dominant planetary influence. Neptune amplifies everything Pisces: the dissolution, the spiritual longing, the confusion, the compassion, and the temptation to escape. This conjunction makes the eclipse\'s revelations feel dreamlike, emotional, and potentially overwhelming. What surfaces may be hard to pin down logically — it arrives through feelings, dreams, body sensations, and intuitive knowing rather than clear facts. Neptune conjunct a South Node lunar eclipse is one of the most powerful configurations for releasing old illusions. The fog lifts — but slowly, like waking from a long dream. Be patient with yourself as clarity emerges.' },
          { planet: 'Jupiter', type: 'square', sign: 'Gemini', meaning: 'Jupiter at ~21° Gemini squares this eclipse. Jupiter is the traditional ruler of Pisces (the eclipse sign\'s dispositor), so there IS a connection — but it\'s complicated. Jupiter in Gemini is in its detriment, meaning its natural generosity and wisdom are scattered, over-extended, and struggling to focus. The square creates tension: Jupiter wants to expand and explore every possibility, but the eclipse is asking you to CONTRACT — to release, to simplify, to let go. This tension can manifest as over-thinking the release process, intellectualizing emotions instead of feeling them, or trying to "learn your way out" of a pattern that needs to be felt and released through the body. The gift of this square: it won\'t let you spiritually bypass. Jupiter in Gemini demands you NAME what you\'re releasing — put words to it, even if imperfectly.' },
        ],
        sarosNote: 'This eclipse belongs to a Saros family that previously activated around September 2006. What was happening in your health, daily routines, or work life then? The themes echoing now have roots in that earlier chapter.',
      },
      {
