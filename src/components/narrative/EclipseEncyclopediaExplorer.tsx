    ...
    events: [
      {
        ...
        description: 'The opening lunar eclipse of the Virgo-Pisces series, in Pisces. Emotional completions around themes of loss, sacrifice, and spiritual surrender. What you\'ve been holding that was never truly yours to carry becomes visible. Neptune conjunct this eclipse amplifies the Pisces fog — revelations arrive through feelings, dreams, and body sensations rather than clear facts. The fog lifts slowly, like waking from a long dream.',
        nodalTheme: 'South Node in Pisces: Old patterns of self-dissolution, martyrdom, and escape are ready to complete. Where have you been giving everything away — your energy, your boundaries, your clarity — without replenishment? This is the first signal of a multi-year clearing.',
        releasingThemes: [
          'Patterns of escapism or chronic avoidance of practical reality',
          'Martyrdom — giving beyond capacity and quietly resenting it',
          'Confusion maintained because clarity feels too confronting',
          'Spiritual bypassing — using spirituality to avoid dealing with real life',
        ],
        buildingThemes: [
          'Emotional clarity about what you\'ve been avoiding',
          'A more grounded approach to spiritual practice',
          'The groundwork for healthier daily habits',
        ],
        reflectionQuestions: [
          'Where have I been the martyr — giving beyond my capacity and resenting it?',
          'What am I using as an escape from the practical reality I need to face?',
          'Where have I dissolved my own needs into someone else\'s story?',
        ],
        aspects: [
          { planet: 'Neptune', type: 'conjunction', sign: 'Pisces', meaning: 'Neptune at ~28° Pisces is conjunct this eclipse within 3° — the dominant planetary influence. Neptune amplifies everything Pisces: the dissolution, the spiritual longing, the confusion, the compassion, and the temptation to escape. What surfaces may be hard to pin down logically — it arrives through feelings, dreams, body sensations, and intuitive knowing rather than clear facts. Neptune conjunct a lunar eclipse is one of the most powerful configurations for releasing old illusions. Be patient with yourself as clarity emerges.' },
          { planet: 'Jupiter', type: 'square', sign: 'Gemini', meaning: 'Jupiter at ~21° Gemini squares this eclipse. Jupiter is the traditional ruler of Pisces (the eclipse sign\'s dispositor), but in Gemini it\'s in detriment — scattered, over-extended, struggling to focus. The square creates tension: Jupiter wants to expand and explore every possibility, but the eclipse is asking you to release and simplify. This can manifest as over-thinking the release process or intellectualizing emotions instead of feeling them.' },
        ],
        sarosNote: 'This eclipse belongs to a Saros family that previously activated around September 2006. What was happening in your health, daily routines, or work life then?',
      },
      {
      ...
      },
      {
        ...
        description: 'A total lunar eclipse in Virgo — the Blood Moon. This is a South Node eclipse: it brings what has been forming in the background directly in front of you. The harvest is now visible — what have your daily habits, routines, and systems actually produced? This is not a judgment. It is a revelation. The eclipse illuminates both what is working beautifully and what has been running on autopilot past its expiration date. Virgo is the sign of health — emotional AND physical body — of service, of daily rituals and routines, of what you give through your work. Every eclipse has a flavor, and this one asks: "Show me what is hidden. Show me what is outdated or has run its course. What is no longer needed — so I can let it go and make room for something new?" You will see perfectionism, worry, and self-criticism surface. That\'s the shadow of Virgo becoming visible so you can work with it consciously.',
        nodalTheme: 'South Node in Virgo: The Moon (your instinct, your past, your attachments, your emotional body) is near the South Node — the karmic past. The South Node of the Moon represents past patterns, the unconscious contracts you made long ago to get love, to feel safe, to stay connected. These were nervous system strategies that once protected you, but they have become burdens your younger parts are still carrying. The pattern from long ago is RIGHT HERE, visible in your body. Meanwhile, the Sun sits with the North Node in Pisces — that is where your soul wants to go. You, on Earth, are in the middle. Your job is to interrupt the pattern from long ago. To work with your shadow — not push it away, but hold it, see it, and consciously choose to release what no longer serves. This specific eclipse is EASIER than most South Node eclipses because Jupiter in Cancer (its exaltation) provides genuine support — you have discernment on your side. Jupiter says: "I\'ll give you the emotional wisdom to FEEL which patterns are truly done. Trust that knowing."',
        releasingThemes: [
          'Unconscious contracts — agreements you made with yourself long ago to get love or stay safe that now limit you',
          'Nervous system strategies that were once protective but have become automatic patterns running past their expiration',
          'Perfectionism, worry, and self-criticism (Virgo shadow) that masquerade as "being responsible"',
          'Routines and habits that have become automatic but no longer serve you',
          'Over-optimizing for productivity at the expense of your wellbeing',
          'Work or service that drains without replenishing',
          'Functioning well inside a system that isn\'t actually yours',
          'The burdens your younger parts are still holding — exiles that need acknowledgment, not suppression',
        ],
        buildingThemes: [
          'Clarity about what in your daily life is genuinely working — Jupiter\'s gift is discernment, helping you FEEL the difference between nourishing and obligatory',
          'Somatic awareness: noticing where patterns show up in your body and working WITH the body instead of overriding it',
          'Emotional clarity about what you have genuinely outgrown versus what you are avoiding',
          'The practical wisdom accumulated through years of refinement',
          'A foundation of discernment to carry into the next chapter',
        ],
        reflectionQuestions: [
          'What unconscious contract am I still honoring — what did I agree to long ago in order to feel loved or safe?',
          'Where is this pattern showing up in my body right now? What is my body trying to tell me that I keep overriding with productivity?',
          'What nervous system strategy (people-pleasing, perfectionism, withdrawal, over-giving) has run its course?',
          'What does my daily life actually look like — and is it aligned with what I say I value?',
          'Where have I been tending a system that serves someone else\'s vision more than my own?',
          'Where has functioning well replaced living in alignment?',
          'What burden is my younger self still carrying that my adult self can now set down?',
        ],
        aspects: [
          { planet: 'Jupiter', type: 'sextile', sign: 'Cancer', meaning: 'Jupiter is in Cancer — the sign of its exaltation, where it functions at its absolute best. Jupiter in Cancer expands through nurturing, emotional generosity, and protecting what matters. It\'s the "abundant caretaker" energy in the collective. This Jupiter sextiles the eclipsed Moon in Virgo. A sextile is a 60° angle — it\'s supportive but requires YOU to act. Think of it like a door that\'s been unlocked for you, but you still have to turn the handle. Jupiter is saying: "I\'ll give you the emotional wisdom, the expanded perspective, the gut-feeling clarity — but you have to apply it to your daily routines (Virgo)." Practically, this means the eclipse\'s audit of your habits and systems gets a boost of emotional intelligence. You can FEEL which routines genuinely nourish you versus which ones you\'ve been maintaining out of obligation. Jupiter in Cancer helps you distinguish between "I do this because it feeds my soul" and "I do this because I\'d feel guilty stopping." This is why this eclipse, despite being a South Node release, has a quality of EASE — you have discernment on your side. The sextile is also an opening aspect — it\'s the beginning of a new method. The goal (serving, contributing, being healthy) may be right, but the WAY you\'ve been doing it needs an upgrade. Jupiter offers the upgrade through Cancer\'s wisdom: lead with care, not efficiency.' },
          { planet: 'Jupiter', type: 'trine', sign: 'Cancer', meaning: 'Simultaneously, Jupiter in Cancer trines the Sun in Pisces (the other end of this eclipse axis). A trine is 120° — the most naturally flowing aspect. It\'s support that arrives without you having to fight for it. Water trine (Cancer to Pisces) means this flows through emotion, intuition, and spiritual knowing rather than logic. The Sun in Pisces is asking "What is the deeper meaning behind my life?" and Jupiter in Cancer answers with "The meaning is in what you nurture — the people you love, the home you\'ve built, the emotional legacy you\'re creating." This is the cosmic permission slip to stop chasing productivity metrics and reconnect with WHY you do what you do. Jupiter in Cancer trine Pisces Sun dissolves the false boundary between "spiritual life" and "daily life." The sacred isn\'t somewhere else — it\'s in the meal you cook, the person you comfort, the garden you tend. For YOU during this eclipse: the trine ensures that even as the lunar eclipse audits and releases old Virgo patterns, you won\'t feel abandoned. Jupiter is the safety net. It\'s saying: "Yes, let go of what isn\'t working — and trust that something more nourishing is already growing underneath."' },
        ],
