...
import { MythologyEncyclopediaExplorer } from './MythologyEncyclopediaExplorer';
  ...
  return (
    <div className="mt-8 space-y-8">
      <div className="flex items-center gap-2 border-b pb-3">
        ...
        <span className="text-xs text-muted-foreground ml-auto">Signs · Planets · Mythology · Elements · Polarity</span>
      </div>
