  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
        ...
        <div className="bg-muted/50 rounded-lg p-3">
          <p className="text-xs font-semibold uppercase tracking-widest text-foreground mb-0.5">SR → Natal</p>
          <p className="text-[9px] text-muted-foreground/70 mb-1.5">How this year personally impacts you</p>
