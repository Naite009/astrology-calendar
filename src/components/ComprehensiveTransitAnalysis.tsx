...
const generatePracticalMeaning = (transitPlanet: string, natalPlanet: string, aspectType: string, natalHouse?: number | null): string => {
  ...
  const practicalDB: Record<string, string> = {
    ...
    'pluto-conjunction-sun': 'Who you are at your core is being completely transformed. You may feel like a different person is emerging. Old identities are dying so a more honest you can be born.',
    'pluto-opposition-sun': 'You\'re facing powerful forces (people, situations, or inner compulsions) that challenge who you think you are. Power struggles may arise. The point is to reclaim your honest power.',
    ...
    'uranus-square-sun': 'You\'re feeling a strong urge to break free from anything that feels confining — a job, a relationship, an identity. Sudden changes may happen. The goal is to become more honestly yourself, not just rebel for rebellion\'s sake.',
  };
...
const TRANSIT_PLANET_FEELING: Record<string, { verb: string; somatic: string; psyche: string; esoteric: string }> = {
  sun: { verb: 'illuminates', somatic: 'Warmth in the chest, a surge of vitality, heightened awareness of your heartbeat. You feel more SEEN — for better or worse.', psyche: 'Your ego and conscious identity are lit up. You become acutely aware of how you present yourself and whether you are living honestly.', esoteric: 'The Sun is the spotlight of consciousness — it makes visible what was hidden. Nothing can stay in shadow under this light.' },
